...
st.title("Air Cooler Performance Curve Analysis")
    ...
    if st.button("Generate Performance Curves"):
        with st.spinner("Processing data and generating plots..."):
            try:
                ...
                # Provide download button for Plot 1
                buf1 = io.BytesIO()
                fig1.savefig(buf1, format='png', bbox_inches='tight')
                buf1.seek(0)
                st.download_button(
                    label="Download UA & Duty Plot",
                    data=buf1,
                    file_name="Air_Cooler_Performance_Curve_UA_Duty.png",
                    mime="image/png"
                )
                ...
                # Provide download button for Plot 2
                buf2 = io.BytesIO()
                ...
                st.success("Performance curves generated successfully!")
